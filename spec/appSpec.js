...
describe("berlin horloge for hourSimple", function () {
  ...
  it("hourSimpleFive should return RRRR when given 20", function () {
    const result = main.hourSimpleFive(20);

    expect(result).toBe("RRRR");
  });

  it("hourSimpleFive should return RRRR when given 21", function () {
    const result = main.hourSimpleFive(21);
...
describe("berlin horloge for secondSimple", function () {
    ...
    it("secondSimple should return R when given 2", function () {
        const result = main.secondSimple(2);

        expect(result).toBe("R");
    });

    it("secondSimple should return O when given 3", function () {
        const result = main.secondSimple(3);
